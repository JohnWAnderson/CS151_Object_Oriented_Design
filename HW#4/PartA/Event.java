...
public class Event
{
	 ...
	 */
	public Event(String theName, String theDate, String theTime, String endTime)
	{
		name = theName;
		date = theDate;
		time = theTime;
	...
	{
		int hold  =  (60 * Integer.parseInt(time.substring(0,2))) + ((Integer.parseInt(time.substring(3,5))));
		return hold;
	}
	/**
	 * Gets the value of the time event
	 * @return EndTime  the time the event ends
	 */
	public int getEndTime()
	{
		int hold  =  (60 * Integer.parseInt(endtime.substring(0,2))) + ((Integer.parseInt(endtime.substring(3,5))));
		return hold;
	}
	/**
