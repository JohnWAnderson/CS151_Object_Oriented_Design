...
public class Telephone
{
   ...
   */
   public Telephone()
   {
      ...
      JScrollPane scroll = new JScrollPane(microphoneField, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
      microphonePanel.add(scroll,  BorderLayout.CENTER);
